...
@section('content')
     ...
     <div class="main-panel">
        <div class="content-wrapper">
          <h3 style="margin-bottom: 30px" class="pl-1 text-primary font-weight-bold"><i style="font-size: 21.5px" class="fa-regular fa-file-lines"></i> - Adicionar nova despesa</h3>
                    ...
                    <form method="POST" class="forms-sample">
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control" name="status">
                            <option <?php if(old('status') && old('status') == 0) {echo 'selected';}  ?>  value="0" selected>Pendente</option>
                            <option <?php if(old('status') && old('status') == 1) {echo 'selected';}  ?>  value="1">Paga</option>
                        </select>
                      </div> 
                      <div class="form-group">
